...
name: Fintoc
slug: fintoc
source-url: https://www.fintoc.com
created: 2026-08-19
updated: 2026-08-19
notes: Fintoc web brand
-->
...
> **Brand palette source:** sampled from `https://www.fintoc.com` on 2026-08-19. The site exposes `#080909` brand ink, `#5a626a` secondary text, `#057aff` accent, `#f4f6f6` alternate background, and `#0809091a` borders. `paper` uses Fintoc's `#f9fafa` near-white instead of pure white; `link` uses the darker brand blue for accessible text.
